...
#what we are doing here is overiding rep with factor and creating a treatment name column using funciton paste0
rcbd_dfw
```
...
#facet grid makes different facets for different levels you have , for us it looks at K rate and creates its own plots for each diferent value
